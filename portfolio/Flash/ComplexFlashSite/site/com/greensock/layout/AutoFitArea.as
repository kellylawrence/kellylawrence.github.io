 ...
 * DATE: 2010-03-06
 * AS3
 * UPDATES AND DOCUMENTATION AT: https://www.greensock.com/autofitarea/
 **/
 ...
 */	 
	public class AutoFitArea extends Shape {
		...
		public static function createAround(target:DisplayObject, scaleMode:String=ScaleMode.PROPORTIONAL_INSIDE, hAlign:String=AlignMode.CENTER, vAlign:String=AlignMode.CENTER, crop:Boolean=false, minWidth:Number=0, maxWidth:Number=999999999, minHeight:Number=0, maxHeight:Number=999999999,  previewColor:uint=0xFF0000):AutoFitArea {
			...
			afa.attach(target, scaleMode, hAlign, vAlign, crop, minWidth, maxWidth, minHeight, maxHeight);
			return afa;
		}
		 ...
		 */
		public function attach(target:DisplayObject, scaleMode:String=ScaleMode.PROPORTIONAL_INSIDE, hAlign:String=AlignMode.CENTER, vAlign:String=AlignMode.CENTER, crop:Boolean=false, minWidth:Number=0, maxWidth:Number=999999999, minHeight:Number=0, maxHeight:Number=999999999, customAspectRatio:Number=NaN):void {
